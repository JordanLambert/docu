...
public partial class ManageDelete : System.Web.UI.Page
{
    ...
    private bool UpdateCountryGrade(MySqlConnection connection)
    {
        ...
        try
        {
            ...
            //display the countries
            String sql = "SELECT userType,env FROM user_environment_relationship ORDER BY userType,env ASC";
    ...
    private bool UpdateCountryGradeTopic(MySqlConnection connection)
    {
        ...
        try
        {
            ...
            //display the countries
            String sql = "SELECT userType,env,tid FROM user_environment_topic_relation ORDER BY userType,env,tid ASC";
    ...
    private bool UpdateLessons(MySqlConnection connection)
    {
        ...
        try
        {
            ...
            String sql = "SELECT userType,env,tid,lid,text,filename FROM lessons  ORDER BY userType,env,tid,lid ASC";
    ...
    {
        Session["olduserType"] = gridCountry.Rows[e.NewEditIndex].Cells[0].Text;
    ...
    protected void Country_OnRowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string newuserType = ((TextBox)(row.Cells[0].Controls[0])).Text;
        string olduserType = (string)Session["olduserType"];
        ...
        try
        {
            ...
            String sql = "UPDATE countries SET userType = (@newuserType) WHERE userType = (@olduserType)";
    ...
    protected void Country_OnRowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            ...
            String sql = "SELECT COUNT(userType) as count FROM user_environment_relationship WHERE userType = (@userType)";

            using (MySqlCommand cmd = new MySqlCommand(sql, connection))
            {

                cmd.Parameters.AddWithValue("@userType", countryToDelete);
                ...
                if (canRemove)
                {
                    sql = "DELETE FROM user WHERE userType = (@userType)";
    ...
    protected void Topic_OnRowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            ...
            String sql = "SELECT COUNT(tid) as count FROM user_environment_topic_relation WHERE tid = (@tid)";
    ...
    protected void CountryGrade_OnRowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            ...
            String sql = "SELECT COUNT(userType) as count FROM user_environment_topic_relation WHERE userType = (@userType) AND env = (@env)";

            using (MySqlCommand cmd = new MySqlCommand(sql, connection))
            {

                cmd.Parameters.AddWithValue("@userType", countryToDelete);
                cmd.Parameters.AddWithValue("@env", gradeToDelete);
                ...
                if (canRemove)
                {
                    sql = "DELETE FROM user_environment_relationship WHERE userType = (@userType) AND env = (@env)";
    ...
    protected void CountryGradeTopic_OnRowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        if (RemoveTopic(country, grade, topic))
        {
            ...
            try
            {
                ...
                String sql = "DELETE FROM user_environment_topic_relation WHERE userType = (@userType) AND env = (@env) AND tid = (@tid)";

                using (MySqlCommand cmd = new MySqlCommand(sql, connection))
                {

                    cmd.Parameters.AddWithValue("@userType", country);
                    cmd.Parameters.AddWithValue("@env", grade);
    ...
    private bool RemoveTopic(string country, string grade, string topic)
    {
        ...
        try
        {
            ...
            String sql = "SELECT lid FROM lessons WHERE userType = (@userType) AND env = (@env) AND tid = (@tid);";
    ...
    protected void Lesson_OnRowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string userType = row.Cells[0].Text;
        string env = row.Cells[1].Text;
        ...
        try
        {
            ...
            String sql = "UPDATE lessons SET lid = (@newLid), text = (@newText) WHERE userType = (@userType) AND env = (@env) AND tid = (@tid) AND lid = (@oldLid)";
    ...
    private bool LessonDelete(string country, string grade, string topic, string lid)
    {
        ...
        if (RemoveFile(country, grade, topic, lid))
        {
            ...
            try
            {
                ...
                String sql = "DELETE FROM lessons WHERE userType = (@userType) AND env = (@env) AND tid = (@tid) AND lid = (@lid)";
    ...
    private bool RemoveFile(string country, string grade, string topic, string lid)
    {
        ...
        try
        {
            ...
            String sql = "SELECT COUNT(userType) as count, filename, ext FROM lessons WHERE path = (" +
                                    "SELECT path FROM lessons WHERE userType = (@userType) AND env = (@env) AND tid = (@tid) AND lid = (@lid));";
