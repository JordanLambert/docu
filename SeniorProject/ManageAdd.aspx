...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblCountryAdd" runat="server" Text="Add a User:" style="z-index: 1; left: 42px; top: 130px; position: absolute"></asp:Label>
        ...
        <asp:Label ID="lblCountryGradeAdd" runat="server" Text="Add a <br> Environment<br>to a User:" style="z-index: 1; left: 57px; top: 230px; position: absolute"></asp:Label>
        ...
        <asp:Label ID="lblCountryGradeTopicAdd" runat="server" Text="Add a Topic to a<br>Users's <br>Environment:" style="z-index: 1; left: 31px; top: 290px; position: absolute"></asp:Label>
        ...
        <!-- Submit buttons -->
        <asp:Button ID="addCountry" runat="server" Text="Add User" style="z-index: 1; left: 350px; top: 130px; position: absolute" OnClick="AddCountry_Click" />
        ...
        <asp:Button ID="addCountryGrade" runat="server" Text="Add User Environment" style="z-index: 1; left: 550px; top: 240px; position: absolute" OnClick="AddCountryGrade_Click" />
        <asp:Button ID="addCountryGradeTopic" runat="server" Text="Add User Environment Topic" style="z-index: 1; left: 600px; top: 300px; position: absolute;" OnClick="AddCountryGradeTopic_Click" />
        ...
        <asp:GridView ID="gridLesson" runat="server" AutoGenerateColumns="False" AutoPostBack="True" OnRowDataBound="Lesson_DataBound">
            <Columns>
                <asp:BoundField HeaderText="Country" DataField="userType" ReadOnly="true"/>
                <asp:BoundField HeaderText="Grade" DataField="env" ReadOnly="true"/>
